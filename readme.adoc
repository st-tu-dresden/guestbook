...
NOTE: The Quickstart requires Java 8, Maven 3 and a recent Git (2.2.x preferred) to be available on your machine. If you miss any of those go through the steps described in <<prerequisites>>
