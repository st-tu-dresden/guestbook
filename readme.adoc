...
NOTE: Working on your local machine requires Java 21, and a recent Git (2.51 or better preferred) to be available on your machine.
...
Maven home: /Users/odrotbohm/.m2/wrapper/dists/apache-maven-3.9.11/a2d47e15
