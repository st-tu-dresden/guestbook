...
class GuestbookForm {
	...
	private final @NotBlank String color;
	 ...
	 */
	public GuestbookForm(String name, String text, String color) {
	...
	/**
	 * Returns the value bound to the {@code color} attribute of the request. Needs to be public so that Spring will
	 * actually consider it for form data binding until
	 * {@link https://github.com/spring-projects/spring-framework/issues/22600} is resolved.
	 *
	 * @return the value bound to {@code color}
	 */
	...
	GuestbookEntry toNewEntry() {
		return new GuestbookEntry(getName(), getText(), getColor());
	}
}
